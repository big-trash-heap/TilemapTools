...
function tilemapAuto16def_set_cd(_tilemapElementId, _cellX, _cellY, _offsetTile=1) {
	...
	// top
	if (tilemapModify(_tilemapElementId, _cellX, _cellY - 1, _mask_12_t, __tilemapAuto16def_set, _offsetTile)) {
		
		//
		if (_mask_12_t == 0) {
			
			tilemapModify(_tilemapElementId, _cellX - 1, _cellY - 1, _mask_10_l, __tilemapAuto16def_set, _offsetTile); // left-top
			tilemapModify(_tilemapElementId, _cellX + 1, _cellY - 1, _mask_05_r, __tilemapAuto16def_set, _offsetTile); // right-top
		}
		else {
	...
	// down
	if (tilemapModify(_tilemapElementId, _cellX, _cellY + 1, _mask_03_d, __tilemapAuto16def_set, _offsetTile)) {
		
		//
		if (_mask_03_d == 0) {
			
			tilemapModify(_tilemapElementId, _cellX - 1, _cellY + 1, _mask_10_l, __tilemapAuto16def_set, _offsetTile); // left-down
			tilemapModify(_tilemapElementId, _cellX + 1, _cellY + 1, _mask_05_r, __tilemapAuto16def_set, _offsetTile); // right-down
		}
		else {
	...
	// left
	if (tilemapModify(_tilemapElementId, _cellX - 1, _cellY, _mask_10_l, __tilemapAuto16def_set, _offsetTile)) {
		
		//
		if (_mask_10_l == 0) {
			
			tilemapModify(_tilemapElementId, _cellX - 1, _cellY - 1, _mask_12_t, __tilemapAuto16def_set, _offsetTile); // left-top
			tilemapModify(_tilemapElementId, _cellX - 1, _cellY + 1, _mask_03_d, __tilemapAuto16def_set, _offsetTile); // left-down
		}
		else {
	...
	// right
	if (tilemapModify(_tilemapElementId, _cellX + 1, _cellY, _mask_05_r, __tilemapAuto16def_set, _offsetTile)) {
		
		//
		if (_mask_05_r == 0) {
			
			tilemapModify(_tilemapElementId, _cellX + 1, _cellY - 1, _mask_12_t, __tilemapAuto16def_set, _offsetTile); // right-top
			tilemapModify(_tilemapElementId, _cellX + 1, _cellY + 1, _mask_03_d, __tilemapAuto16def_set, _offsetTile); // right-down
		}
		else {
...
function tilemapAuto16defAPix_set_cd(_tilemapElementId, _x, _y, _offsetTile) {
	__tilemapCallAPix(_tilemapElementId, _x, _y, _offsetTile, tilemapAuto16def_set_cd);
}
